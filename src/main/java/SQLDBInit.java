...
// TODO узнать как правильно инициализировать Ѕƒ и переделать
public class SQLDBInit {
    ...
    // шаблоны запросов и людские имена дл€ наполнени€ таблиц тестовыми данными
    ...
    public static void init() {
        ...
        try {
            ...
            // варим стэйтмент дл€ отправки запросов нашей Ѕƒ
...
//                // "insert into users (name, age, isAdmin, createdDate) values ('Ivan', '1', true, '1990-03-20');
    ...
    private static List<Integer> getAccountsIDs(Statement statement) throws SQLException {
        // TODO разобратьс€ почему и зачем закрываетс€ ResultSet
